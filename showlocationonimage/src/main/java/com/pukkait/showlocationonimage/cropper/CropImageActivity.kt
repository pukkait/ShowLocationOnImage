...
import com.pukkait.showlocationonimage.cropper.utils.getUriForFile
import java.io.File
...
open class CropImageActivity :
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_crop_done).setOnClickListener {
            cropImage()
        }
        findViewById<ImageView>(R.id.img_rotate).setOnClickListener {
            rotateImage(cropImageOptions.rotationDegrees)
        }
        findViewById<ImageView>(R.id.img_flip).setOnClickListener {
    ...
    private fun setCustomizations() {
        cropImageOptions.activityBackgroundColor.let { activityBackgroundColor ->
            cropImageView.setBackgroundColor(activityBackgroundColor)
        }
...
//    }
    ...
    open fun setResult(uri: Uri?, error: Exception?, sampleSize: Int) {
        ...
        setResult(error?.let { CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE } ?: RESULT_OK,
            resultIntent)
        finish()
    }
